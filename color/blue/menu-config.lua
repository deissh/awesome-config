...
function menu:init(args)
	...
	self.mainmenu = redflat.menu({ theme = theme,
		items = {
			...
			{ "Chrome",        env.browser,  		micon("browser") },
			{ "Telegram",      "telegram-desktop",  micon("telegram-desktop") },
			separator,
			{ "VS Code",       "code",       micon("code") },
			{ "GoLand",        "goland",     micon("goland") },
			{ "Rider",         "rider",      micon("rider") },
			separator,
